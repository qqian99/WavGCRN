...
class DGCRN(nn.Module):
    def __init__(self,
        ...
        self.IDWT_L = IDWTL([325, self.hidden_size_en])
        self.IDWT_H = IDWTL([325, self.hidden_size_en])
        '''
        self.gl1 = GraphClf(self.config, self.device)
        self.gl2 = GraphClf(self.config, self.device)
        self.gl3 = GraphClf(self.config, self.device)
        '''
        self.gz1 = gcn(dims_de, gcn_depth, dropout, *list_weight, 'RNN')
        self.gz2 = gcn(dims_de, gcn_depth, dropout, *list_weight, 'RNN')
        self.gr1 = gcn(dims_de, gcn_depth, dropout, *list_weight, 'RNN')
        self.gr2 = gcn(dims_de, gcn_depth, dropout, *list_weight, 'RNN')
        self.gc1 = gcn(dims_de, gcn_depth, dropout, *list_weight, 'RNN')
        self.gc2 = gcn(dims_de, gcn_depth, dropout, *list_weight, 'RNN')
    ...
    def forward(self,
        ...
        embedding_feature1 = Hidden_State_1
        ...
        embedding_feature2 = Hidden_State_2
        ...
        #cov_com = [task_level, 6.0]
        #cov_com = [x / sum(cov_com) for x in cov_com]
        #print("task level: ", task_level)
        #print("bili: ", cov_com)
        ...
        #Hidden_State = self.aggH(Hidden_State_1, Hidden_State_2)
        #Cell_State =  self.aggC(Cell_State_1, Cell_State_2)
